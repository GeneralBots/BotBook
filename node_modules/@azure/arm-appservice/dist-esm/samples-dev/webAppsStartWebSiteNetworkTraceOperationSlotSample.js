 ...
 */
function startANewNetworkTraceOperationForASite() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.webApps.beginStartWebSiteNetworkTraceOperationSlotAndWait(resourceGroupName, name, slot, options);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=webAppsStartWebSiteNetworkTraceOperationSlotSample.js.map