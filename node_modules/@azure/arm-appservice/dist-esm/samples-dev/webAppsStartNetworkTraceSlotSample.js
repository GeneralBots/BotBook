...
function startANewNetworkTraceOperationForASite() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.webApps.beginStartNetworkTraceSlotAndWait(resourceGroupName, name, slot, options);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=webAppsStartNetworkTraceSlotSample.js.map