...
function registerAUserProvidedFunctionAppWithAStaticSite() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const options = { isForced };
        const credential = new DefaultAzureCredential();
        const client = new WebSiteManagementClient(credential, subscriptionId);
        const result = yield client.staticSites.beginRegisterUserProvidedFunctionAppWithStaticSiteAndWait(resourceGroupName, name, functionAppName, staticSiteUserProvidedFunctionEnvelope, options);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=staticSitesRegisterUserProvidedFunctionAppWithStaticSiteSample.js.map