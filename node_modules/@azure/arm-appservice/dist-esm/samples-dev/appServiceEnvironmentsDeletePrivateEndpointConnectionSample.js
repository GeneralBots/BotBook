...
function deletesAPrivateEndpointConnection() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.appServiceEnvironments.beginDeletePrivateEndpointConnectionAndWait(resourceGroupName, name, privateEndpointConnectionName);
        console.log(result);
    });
}
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        deletesAPrivateEndpointConnection();
    });
}
main().catch(console.error);
//# sourceMappingURL=appServiceEnvironmentsDeletePrivateEndpointConnectionSample.js.map