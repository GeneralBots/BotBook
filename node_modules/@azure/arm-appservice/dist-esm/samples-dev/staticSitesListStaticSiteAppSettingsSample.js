...
function getAppSettingsOfAStaticSite() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.staticSites.listStaticSiteAppSettings(resourceGroupName, name);
        console.log(result);
    });
}
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        getAppSettingsOfAStaticSite();
    });
}
main().catch(console.error);
//# sourceMappingURL=staticSitesListStaticSiteAppSettingsSample.js.map