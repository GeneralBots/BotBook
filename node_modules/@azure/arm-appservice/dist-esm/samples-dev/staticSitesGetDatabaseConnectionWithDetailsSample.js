 ...
 */
function getDetailsOfDatabaseConnectionsForTheStaticSite() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.staticSites.getDatabaseConnectionWithDetails(resourceGroupName, name, databaseConnectionName);
        console.log(result);
    });
}
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        getDetailsOfDatabaseConnectionsForTheStaticSite();
    });
}
main().catch(console.error);
//# sourceMappingURL=staticSitesGetDatabaseConnectionWithDetailsSample.js.map