...
function executeSiteAnalysis() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.diagnostics.executeSiteAnalysisSlot(resourceGroupName, siteName, diagnosticCategory, analysisName, slot);
        console.log(result);
    });
}
/**
 ...
 */
function executeSiteSlotAnalysis() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APPSERVICE_SUBSCRIPTION_ID"] ||
            "34adfa4f-cedf-4dc0-ba29-b6d1a69ab345";
        const resourceGroupName = process.env["APPSERVICE_RESOURCE_GROUP"] || "Sample-WestUSResourceGroup";
...
//# sourceMappingURL=diagnosticsExecuteSiteAnalysisSlotSample.js.map