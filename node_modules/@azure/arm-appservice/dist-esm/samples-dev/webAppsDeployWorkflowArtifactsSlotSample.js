...
function deploysWorkflowArtifactsSlot() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.webApps.deployWorkflowArtifactsSlot(resourceGroupName, name, slot, options);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=webAppsDeployWorkflowArtifactsSlotSample.js.map