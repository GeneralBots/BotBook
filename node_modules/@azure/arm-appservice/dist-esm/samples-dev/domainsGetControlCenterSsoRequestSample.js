 ...
 */
function getDomainControlCenterSsoRequest() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APPSERVICE_SUBSCRIPTION_ID"] ||
            "34adfa4f-cedf-4dc0-ba29-b6d1a69ab345";
        const credential = new DefaultAzureCredential();
        const client = new WebSiteManagementClient(credential, subscriptionId);
        const result = yield client.domains.getControlCenterSsoRequest();
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=domainsGetControlCenterSsoRequestSample.js.map