...
function getFunctionAppSettingsOfAStaticSite() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.staticSites.listStaticSiteFunctionAppSettings(resourceGroupName, name);
        console.log(result);
    });
}
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        getFunctionAppSettingsOfAStaticSite();
    });
}
main().catch(console.error);
//# sourceMappingURL=staticSitesListStaticSiteFunctionAppSettingsSample.js.map