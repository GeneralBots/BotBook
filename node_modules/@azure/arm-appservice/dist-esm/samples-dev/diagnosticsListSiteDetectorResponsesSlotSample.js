 ...
 */
function getAppDetectorResponses() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _d = true, _e = __asyncValues(client.diagnostics.listSiteDetectorResponsesSlot(resourceGroupName, siteName, slot)), _f; _f = yield _e.next(), _a = _f.done, !_a; _d = true) {
                _c = _f.value;
                _d = false;
                let item = _c;
                resArray.push(item);
 ...
 */
function getAppSlotDetectorResponses() {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, e_2, _b, _c;
        const subscriptionId = process.env["APPSERVICE_SUBSCRIPTION_ID"] ||
            "34adfa4f-cedf-4dc0-ba29-b6d1a69ab345";
...
//# sourceMappingURL=diagnosticsListSiteDetectorResponsesSlotSample.js.map